...
const GamesCollection = [
  {
    ...
    key: 'malign',
    name: 'Malign',
    description: 'Un juego a cerca de guerra y comunicaciones',
    teams: [
...
async function insertSampleData() {
  try {
    ...
    await PredefinedGame.deleteMany({});
    await GameSession.deleteMany({});

    await PredefinedGame.insertMany(GamesCollection);
    await GameSession.insertMany(GameSessionCollection);
